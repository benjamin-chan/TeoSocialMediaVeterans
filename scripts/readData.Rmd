...
```{r}
df1 <-
  "C:/Users/chanb/Box Sync/Facebook pilot - Statisticians/Data sets/Lifetime ad performance by ad-day 6.23.17.csv" %>% 
...
```{r}
df2 <-
  "C:/Users/chanb/Box Sync/Facebook pilot - Statisticians/Data sets/REDCap dataset.csv" %>% 
  read.csv(stringsAsFactors = FALSE) %>% 
  rename(branchArmy = active_duty_branch___1,
         branchNavy = active_duty_branch___2,
         branchAirForce = active_duty_branch___3,
         branchMarineCorp = active_duty_branch___4,
         branchCoastGuard = active_duty_branch___5,
         branchOther = active_duty_branch___6,
         era1Current = active_duty_era___1,
         era2GulfWar = active_duty_era___2,
         era3PreGulfWar = active_duty_era___3,
         era4Vietnam = active_duty_era___4,
         era5PreVietnam = active_duty_era___5,
         era6Korea = active_duty_era___6,
         era7PreKorea = active_duty_era___7,
         era8WWII = active_duty_era___8,
         era9PreWWII = active_duty_era___9)
df2 %>% 
  group_by(consent, 
