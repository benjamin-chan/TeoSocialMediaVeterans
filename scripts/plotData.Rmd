...
G <- plotRates("clicksTotal", "impressions", "clicksTotal", "Number of ad clicks")
```
...
G <- plotRates("clicksUnique", "reach", "clicksUnique", "Number of unique ad clicks")
```
...
G <- plotRates("linkClicksTotal", "impressions", "linkClicksTotal", "Number of total link clicks")
```
...
G <- plotRates("linkClicksUnique", "reach", "linkClicksUnique", "Number of unique link clicks")
```
...
G <- plotRates("reactions", "impressions", "reactions", "Number of reactions")
```
...
G <- plotRates("comments", "impressions", "comments", "Number of comments")
```
...
G <- plotRates("shares", "impressions", "shares", "Number of shares")
```
