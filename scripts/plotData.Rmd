...
```{r impressions, fig.show = "hide"}
G <- plotRates("impressions", "Ad impressions")
```
...
```{r reach, fig.show = "hide"}
G <- plotRates("reach", "Ad reach")
```
...
G <- plotRates("clicksTotal", "Number of ad clicks")
```
...
G <- plotRates("clicksUnique", "Number of unique ad clicks")
```
...
G <- plotRates("linkClicksTotal", "Number of total link clicks")
```
...
G <- plotRates("linkClicksUnique", "Number of unique link clicks")
```
...
G <- plotRates("reactions", "Number of reactions")
```
...
G <- plotRates("comments", "Number of comments")
```
...
G <- plotRates("shares", "Number of shares")
```
